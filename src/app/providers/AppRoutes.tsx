    ...
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <Routes>
          ...
          <Route path="/shop" element={<div className="py-10 text-center text-xl">Магазин</div>} /> 
          ...
          <Route path="/contact" element={<div className="py-10 text-center text-xl font-bold">Контакты шоурума</div>} />
